...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<form:form class="form-horizontal" method="post" modelAttribute="userForm">
		...
		<spring:bind path="admin">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<form:label class="control-label col-sm-2" path="admin">Администратор:</form:label>
				<form:checkbox id="admin" path="admin" class="col-sm-2" style="margin-left: 15px; margin-top: 11px;" />
			</div>
		</spring:bind>
