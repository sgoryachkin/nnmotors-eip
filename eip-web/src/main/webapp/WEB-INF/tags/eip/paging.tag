...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
	...
	<jsp:directive.attribute name="pagingData" required="true"
		type="ru.nnmotors.eip.web.ui.component.paging.PagingData" />

	<ul class="pagination">
		<c:forEach items="${pagingData.pages}" var="item">
			...
			<li
				class="${item.active ? 'active' : ''} ${item.disable ? 'disabled' : ''}">
				<c:choose>
